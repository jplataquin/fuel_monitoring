                            ...
                            <tr x-show="(search === '' || '{{ addslashes(strtolower($account->name)) }}'.includes(search.toLowerCase())) && (showInactive || '{{ $account->status }}' === 'Active')"
                                ...
                                <td class="px-4 py-3 align-middle text-end">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('chargeable-accounts.print', $account) }}" target="_blank" class="btn btn-link text-primary p-2 rounded-circle" title="Print Account & Breakdown" style="color: #6366f1;">
