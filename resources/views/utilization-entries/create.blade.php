                        ...
                        <form method="POST" action="{{ route('utilization-entries.store') }}">
                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" id="actual_hours" name="actual_hours" class="form-control bg-dark text-light border-secondary border-opacity-50 py-2 px-3 rounded-3" value="{{ old('actual_hours') }}" placeholder="0.00" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="calculation_type" name="calculation_type" class="form-select bg-dark text-light border-secondary border-opacity-50 py-2 px-3 rounded-3" required>
                                        ...
                                        <option value="Timeframe" {{ old('calculation_type') == 'Timeframe' ? 'selected' : '' }}>Timeframe</option>
                                        <option value="Actual Hours" {{ old('calculation_type') == 'Actual Hours' ? 'selected' : '' }}>Actual Hours</option>
                                    </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <select id="unbudgeted" name="unbudgeted" class="form-select bg-dark text-light border-secondary border-opacity-50 py-2 px-3 rounded-3" required onchange="toggleSubAccount()">
                                        <option value="0" {{ old('unbudgeted') == '0' ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('unbudgeted') == '1' ? 'selected' : '' }}>Yes</option>
                                    </select>
