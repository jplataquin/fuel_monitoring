    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="print-hidden">
                <a href="{{ route('account-budgets.print', request()->query()) }}" target="_blank" class="btn btn-primary rounded-pill px-4 fw-bold small text-uppercase tracking-widest shadow d-inline-flex align-items-center">
