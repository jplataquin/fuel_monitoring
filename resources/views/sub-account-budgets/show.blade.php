    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ route('sub-accounts.show', $accountBudget->sub_account_id) }}" class="btn btn-link text-secondary text-decoration-none small fw-bold text-uppercase tracking-widest ms-2">
                    Back to List
                </a>
            </div>
        </div>
